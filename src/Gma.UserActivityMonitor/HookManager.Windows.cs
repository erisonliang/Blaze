...
namespace Gma.UserActivityMonitor
{
    public static partial class HookManager
    {
        ...
        /// <summary>
        /// The WM_XBUTTONDOWN message is posted when the user presses a X mouse button
        /// </summary>
        private const int WM_XBUTTONDOWN = 0x020B;

        /// <summary>
        /// The WM_XBUTTONUP message is posted when the user releases a X mouse button
        /// </summary>
        private const int WM_XBUTTONUP = 0x020C;

        /// <summary>
        /// The WM_XBUTTONDBLCLK message is posted when the user presses a X button
        /// </summary>
        ...
        private static extern int ToUnicode(uint wVirtKey, uint wScanCode, byte[]
