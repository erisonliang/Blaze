...
namespace SystemCore.SystemAbstraction.WindowManagement
{
    public static class GlassExtender
    {
        ...
        public static void GlassBackground(Window win)
        {
            ...
            GlassBackground(win, -1, 0, 0, 0);
        }
        /// <summary>
        /// Sets glass background to custom margins in the window.
        /// </summary>
        /// <param name="win"></param>
        public static void GlassBackground(Window win, int left, int right, int top, int bottom)
        {
