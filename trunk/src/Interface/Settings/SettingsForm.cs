...
namespace Blaze
{
    public partial class SettingsForm : Form
    {
        ...
        private void SettingsForm_Load(object sender, EventArgs e)
        {
            ...
            // HotKey
            //
            _hotkey = SettingsManager.Instance.GetHotKey();
            // modifiers
            ...
            MainKeyComboBox.SelectedIndex = Array.FindIndex<string>(keys, delegate(string s)
                {
                    return s == _hotkey.KeyName;
                });
            //
            ...
            AutomatorLabel.Text = AssemblyTitle + " " + AssemblyVersion + " beta";
