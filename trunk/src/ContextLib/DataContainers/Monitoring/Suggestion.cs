...
namespace ContextLib.DataContainers.Monitoring
{
    public class Suggestion
    {
        ...
        public void Update(int iterations, bool from_beginnig)
        {
            ...
            {
                narrative = GenerateNewNarrative(iterations, from_beginnig);
                ...
                else
                {
                    while (it <= max)
                    {
                        list.AddRange(GenerateNewActionList(it, from_beginnig));
                        it++;
                    }
                }
            }
            else
            {
                ...
                narrative = GenerateNewNarrative(1, from_beginnig);
                list.AddRange(GenerateNewActionList(1, from_beginnig));
                if (narrative.Trim() == string.Empty)   
                {
