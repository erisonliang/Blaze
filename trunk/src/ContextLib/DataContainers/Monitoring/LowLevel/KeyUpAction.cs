...
namespace ContextLib.DataContainers.Monitoring
{
    public class KeyUpAction : KeyAction
    {
        ...
        public override string IpySnippet
        {
            get
            {
                return
                    ...
                    "action = ContextLib.DataContainers.Monitoring.KeyUpAction(window, System.Windows.Forms.Keys." + _key + ", " + ModifiersIpySnippet + ")" + Environment.NewLine +
        ...
        #region Constructors
        public KeyUpAction(Keys key, Modifiers modifiers)
            : base(key, modifiers)
        {
            _description = "Release " + key.ToString() + " key (Modifiers: " + modifiers + ") on window \"" + _window.Title + "\" (" + _window.ProcessName + ".exe)";
            _quick_description = "KeyUp(" + _key.ToString() + ", " + ((int)modifiers).ToString() + ")";
            _type = UserActionType.KeyUpAction;
        }

        public KeyUpAction(Window window, Keys key, Modifiers modifiers)
