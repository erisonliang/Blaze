...
{
    public class MouseDoubleClickAction : MouseAction
    {
        #region Properties
        ...
        public override string IpySnippet
        {
            get
            {
                return
                    ...
                    "action = ContextLib.DataContainers.Monitoring.MouseDoubleClickAction(window, System.Windows.Forms.MouseButtons." + _button + ", " + _x + ", " + _y + ", " + ModifiersIpySnippet + ")" + Environment.NewLine +
        ...
        #region Constructors
        public MouseDoubleClickAction(MouseButtons button, uint x, uint y, Modifiers modifiers)
            : base(modifiers)
        {
            _button = button;
            _x = x;
            _y = y;
            _description = button.ToString() + " mouse double click (Modifiers: " + modifiers + ") at (" + _x + "," + _y + ") on window \"" + _window.Title + "\" (" + _window.ProcessName + ".exe)";
            _quick_description = "MouseDoubleClick(" + button.ToString() + ", " + x.ToString() + ", " + y.ToString() + ", " + ((int)modifiers).ToString() + ")"; 
            _type = UserActionType.MouseDoubleClickAction;
        }

        public MouseDoubleClickAction(Window window, MouseButtons button, uint x, uint y, Modifiers modifiers)
        ...
        public override bool Equals(object obj)
        {
            ...
            MouseDoubleClickAction action = (MouseDoubleClickAction)obj;
            ...
            {
                if (action.ActionType == UserActionType.MouseDoubleClickAction)
                {
                    MouseDoubleClickAction m_action = (MouseDoubleClickAction)action;
        ...
        {
            MouseDoubleClickAction action = new MouseDoubleClickAction(new Window(_window), _button, _x, _y, _modifiers);
            action.Id = this.Id;
