// from http://stackoverflow.com/questions/294292/changing-master-volume-level
...
namespace SystemCore.SystemAbstraction.WindowManagement
{
    public class VolumeControl
    {
        ...
        [DllImport("WinMM.dll", CharSet = CharSet.Auto)]
        static extern uint mixerGetControlDetails(IntPtr hmxobj, ref MIXERCONTROLDETAILS64 pmxcd, MIXER flags);
