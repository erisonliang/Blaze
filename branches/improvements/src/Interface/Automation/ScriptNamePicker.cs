...
{
    public partial class ScriptNamePicker : Form
    {
        ...
        public ScriptNamePicker(string folder)
        {
            InitializeComponent();
        ...
        private void ScriptNamePicker_Load(object sender, EventArgs e)
        {
            _tooltip = new ToolTip();
        ...
        private void saveButton_Click(object sender, EventArgs e)
        {
            ...
            {
                if (file.ToLower() == macroNameTextBox.Text + ".py")
                {
